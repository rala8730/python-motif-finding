...
//    Searches for the given word within the GST and returns all the indexes 
...
//    Return (n, remainder) pair such that n is a farthest descendant 
     ...
     * @see Tree#searchWithCount(java.lang.String, int) 
     */
